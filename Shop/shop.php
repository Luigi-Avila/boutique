            ...
            <table class="table ">
              ...
              <?php while ($row = mysqli_fetch_assoc($query)){ ?>
                  <tr >
                    ...
                    <th width="8%"
                    ><img src="../Login/IMG/<?php echo $row["foto"]?>" class="card-img" alt="..."></th>
                    <th><?php echo $row['precio']?></th>
                    <th><?php echo $row['cantidad']?></th>
                    <th>
                        <div class="btn-group" role="group" >
                        <a class="btn btn-outline btn-sm" href="detalle.php?id=<?php echo $row['id']?>">Detallar</a>
                        <div class="vr"></div><br>
                        <a class="btn btn-outline btn-sm" onClick="agregarCarrito()" href="ACarrito.php?id=<?php echo $row['id']?>">+</a>    
                        </div>  
                    </th>
                  </tr>
              <?php		
